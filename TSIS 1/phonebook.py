...
def add_phone():
    ...
    if not contact_name or not phone:
        print("Error: Contact name and phone number cannot be empty!")
        return

    raw_type = input("Enter phone type (home/work/mobile): ").strip()
    try:
        phone_type = normalize_phone_type(raw_type)
